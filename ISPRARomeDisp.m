...
sites(2) = struct('Name',"Hamburg Sternschanze",'WebID',"hamburg", ...
 ...
 'AirQualityProvider',"Hamburg_Luftmessnetz",'CPCFolder',fullfile("Hamburg","HU data CPC export from data base"),'CPCPattern',"*.csv",'SMPSFolder',"Hamburg",'SMPSPattern',"SMPS*.csv");
